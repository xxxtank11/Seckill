...
import com.ws.dao.SeckillDao;
import com.ws.dao.SuccessKilledDao;
import com.ws.dao.cache.RedisDao;
...
import com.ws.service.SeckillService;
...
public class SeckillSeviceImpl implements SeckillService {
    //日志对象
    private Logger logger = LoggerFactory.getLogger(SeckillSeviceImpl.class);

    ////加入一个混淆字符串(秒杀接口)的salt，为了我避免用户猜出我们的md5值，值任意给，越复杂越好
    private final String salt = "dfasdDF!@31wrsadf@#%$#$ZCV>";
